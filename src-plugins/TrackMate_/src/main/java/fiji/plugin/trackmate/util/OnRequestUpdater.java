 ...
 * <p>
 * </i> In a later mail, Johannes Schindelin explained to me that this solution
 * was not optimal, and that for general heavy use refreshing, another solution
 * must be sought. In the meantime, it is recommended that this class is used
 * for simple purpose.
 *
