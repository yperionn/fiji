...
public class TMUtils {
	 ...
	 *        the map to inspect.
	 * @param mandatoryKeys
	 *        the collection of keys that are expected to be in the map. Can be
	 *        <code>null</code>.
	 * @param optionalKeys
	 *        the collection of keys that can be - or not - in the map. Can be
	 *        <code>null</code>.
	 * @param errorHolder
	 ...
	 * @param feature
	 *        the feature to consider when choosing what spot to retain in an
	 *        overlapping couple.
	 ...
	 * double array. Calibration is ordered as X, Y, Z. If one axis is not
	 * found, then the calibration for this axis takes the value of 1.
	 */
