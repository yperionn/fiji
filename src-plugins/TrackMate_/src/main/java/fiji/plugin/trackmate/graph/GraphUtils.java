...
public class GraphUtils {
	...
	public static final String toString(final TrackModel model) {
		 ...
		 */
		final Map<Spot, Integer> carretPos = new HashMap<Spot, Integer>(model.vertexSet().size());
	...
	public static final Map<Spot, Integer> cumulativeBranchWidth(final TrackModel model) {
		...
		final Map<Spot, int[]> mappings = new HashMap<Spot, int[]>();
		...
		final Set<Spot> roots = new HashSet<Spot>(model.nTracks(false)); // approx
		final Set<Spot> firsts = new HashSet<Spot>(model.nTracks(false)); // exact
		 ...
		 */
		final Map<Spot, Integer> widths = new HashMap<Spot, Integer>();
		for (final Spot spot : model.vertexSet()) {
	...
	public static final Set<Spot> getSibblings(final DirectedNeighborIndex<Spot, DefaultWeightedEdge> cache, final Spot spot) {
		final HashSet<Spot> sibblings = new HashSet<Spot>();
