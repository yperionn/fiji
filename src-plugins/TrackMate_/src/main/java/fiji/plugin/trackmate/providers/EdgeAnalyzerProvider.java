...
public class EdgeAnalyzerProvider {
	 ...
	 */
	public EdgeAnalyzerProvider(final Model model) {
		this.model = model;
	...
	/**
	 * Returns a new instance of the target edgeFeatureAnalyzer identified by
	...
	/**
	 * Returns a list of the EdgeFeatureAnalyzer names available through this
	 * provider.
	 */
