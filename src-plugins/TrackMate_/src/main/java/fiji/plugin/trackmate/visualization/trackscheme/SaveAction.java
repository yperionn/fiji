...
public class SaveAction extends AbstractAction {
	...
	public void actionPerformed(final ActionEvent e) {
		...
		final HashSet<String> formats = new HashSet<String>();
			...
			if (ext.equalsIgnoreCase("svg")) {
				final mxSvgCanvas canvas = (mxSvgCanvas) mxCellRenderer.drawCells(graph, null, 1, null, new CanvasFactory() {
					...
					public mxICanvas createCanvas(final int width, final int height) {
						final TrackSchemeSvgCanvas canvas = new TrackSchemeSvgCanvas(mxDomUtils.createSvgDocument(width, height));
	...
	private void exportGraphToPdf(final mxGraph graph, final String filename) {
