...
public class LAPUtils {
	...
	/**
	 * @return a new settings map filled with default values suitable for the
	 *         LAP trackers.
	 */
	 ...
	 *        the map to test.
	 * @param errorHolder
	 *        a {@link StringBuilder} that will contain an error message if the
	 ...
	 *        the cost matrix
	 * @param nSegments
	 *        the number of track segments found in the first step of the LAP
	 *        tracking
	 * @param nSpots
