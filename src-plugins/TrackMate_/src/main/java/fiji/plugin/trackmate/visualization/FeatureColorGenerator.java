...
public interface FeatureColorGenerator<K> {
	...
	/**
	 * When this color generator is replaced by another one, calling this method
	 * ensures that it gets correctly unregistered and cleaned, should it be a
	 * model listener or have a heavy memory footprint.
	 */
