...
//		linkingElement.addContent(new Element(TRACKER_SETTINGS_DISTANCE_CUTOFF_ELEMENT).setAttribute(TRACKER_SETTINGS_DISTANCE_CUTOFF_ATTNAME, "" + linkingDistanceCutOff));
//		for (String feature : linkingFeaturePenalties.keySet())
//			linkingElement.addContent(new Element(TRACKER_SETTINGS_FEATURE_ELEMENT).setAttribute(feature, "" + linkingFeaturePenalties.get(feature)));
...
//		gapClosingElement.addContent(new Element(TRACKER_SETTINGS_DISTANCE_CUTOFF_ELEMENT).setAttribute(TRACKER_SETTINGS_DISTANCE_CUTOFF_ATTNAME, "" + gapClosingDistanceCutoff));
//		gapClosingElement.addContent(new Element(TRACKER_SETTINGS_TIME_CUTOFF_ELEMENT).setAttribute(TRACKER_SETTINGS_TIME_CUTOFF_ATTNAME, "" + gapClosingTimeCutoff));
//		for (String feature : gapClosingFeaturePenalties.keySet())
//			gapClosingElement.addContent(new Element(TRACKER_SETTINGS_FEATURE_ELEMENT).setAttribute(feature, "" + gapClosingFeaturePenalties.get(feature)));
...
//		splittingElement.addContent(new Element(TRACKER_SETTINGS_DISTANCE_CUTOFF_ELEMENT).setAttribute(TRACKER_SETTINGS_DISTANCE_CUTOFF_ATTNAME, "" + splittingDistanceCutoff));
//		splittingElement.addContent(new Element(TRACKER_SETTINGS_TIME_CUTOFF_ELEMENT).setAttribute(TRACKER_SETTINGS_TIME_CUTOFF_ATTNAME, "" + splittingTimeCutoff));
//		for (String feature : splittingFeaturePenalties.keySet())
//			splittingElement.addContent(new Element(TRACKER_SETTINGS_FEATURE_ELEMENT).setAttribute(feature, "" + splittingFeaturePenalties.get(feature)));
...
//		mergingElement.addContent(new Element(TRACKER_SETTINGS_DISTANCE_CUTOFF_ELEMENT).setAttribute(TRACKER_SETTINGS_DISTANCE_CUTOFF_ATTNAME, "" + mergingDistanceCutoff));
//		mergingElement.addContent(new Element(TRACKER_SETTINGS_TIME_CUTOFF_ELEMENT).setAttribute(TRACKER_SETTINGS_TIME_CUTOFF_ATTNAME, "" + mergingTimeCutoff));
//		for (String feature : mergingFeaturePenalties.keySet())
//			mergingElement.addContent(new Element(TRACKER_SETTINGS_FEATURE_ELEMENT).setAttribute(feature, "" + mergingFeaturePenalties.get(feature)));
...
//		double val = 0;
//		try {
//			val = element.getChild(TRACKER_SETTINGS_DISTANCE_CUTOFF_ELEMENT).getAttribute(TRACKER_SETTINGS_DISTANCE_CUTOFF_ATTNAME).getDoubleValue();
...
//		double val = 0;
//		try {
//			val = element.getChild(TRACKER_SETTINGS_TIME_CUTOFF_ELEMENT).getAttribute(TRACKER_SETTINGS_TIME_CUTOFF_ATTNAME).getDoubleValue();
//		} catch (DataConversionException e) {
//		}
//		return val;
//	}
