...
public class TrackerKeys {
	...
	//
	// element.setAttribute(TRACKER_SETTINGS_ALTERNATE_COST_FACTOR_ATTNAME,
	// ""+alternativeObjectLinkingCostFactor);
	// element.setAttribute(TRACKER_SETTINGS_CUTOFF_PERCENTILE_ATTNAME,
	// ""+cutoffPercentile);
	// element.setAttribute(TRACKER_SETTINGS_BLOCKING_VALUE_ATTNAME,
	// ""+blockingValue);
	//
	// // Linking
	...
	// .setAttribute(TRACKER_SETTINGS_DISTANCE_CUTOFF_ATTNAME,
	// ""+linkingDistanceCutOff));
	...
	//
	// // Gap-closing
	// Element gapClosingElement = new
	// Element(TRACKER_SETTINGS_GAP_CLOSING_ELEMENT);
	// gapClosingElement.setAttribute(TRACKER_SETTINGS_ALLOW_EVENT_ATTNAME,
	// ""+allowGapClosing);
	...
	// .setAttribute(TRACKER_SETTINGS_TIME_CUTOFF_ATTNAME,
	// ""+gapClosingTimeCutoff));
	...
	//
	// // Splitting
	// Element splittingElement = new
	// Element(TRACKER_SETTINGS_SPLITTING_ELEMENT);
	// splittingElement.setAttribute(TRACKER_SETTINGS_ALLOW_EVENT_ATTNAME,
	// ""+allowSplitting);
	...
	// mergingElement.setAttribute(TRACKER_SETTINGS_ALLOW_EVENT_ATTNAME,
	// ""+allowMerging);
	...
	//
	// alternativeObjectLinkingCostFactor = readDoubleAttribute(element,
	// TRACKER_SETTINGS_ALTERNATE_COST_FACTOR_ATTNAME, Logger.VOID_LOGGER);
	// cutoffPercentile = readDoubleAttribute(element,
	// TRACKER_SETTINGS_CUTOFF_PERCENTILE_ATTNAME, Logger.VOID_LOGGER);
	// blockingValue = readDoubleAttribute(element,
	// TRACKER_SETTINGS_BLOCKING_VALUE_ATTNAME, Logger.VOID_LOGGER);
	// // Linking
	// Element linkingElement =
	// element.getChild(TRACKER_SETTINGS_LINKING_ELEMENT);
	...
	// // Gap-closing
	// Element gapClosingElement =
	// element.getChild(TRACKER_SETTINGS_GAP_CLOSING_ELEMENT);
	// allowGapClosing = readBooleanAttribute(gapClosingElement,
	// TRACKER_SETTINGS_ALLOW_EVENT_ATTNAME, Logger.VOID_LOGGER);
	// gapClosingDistanceCutoff =
	// readDistanceCutoffAttribute(gapClosingElement);
	...
	// element.getChild(TRACKER_SETTINGS_SPLITTING_ELEMENT);
	// allowSplitting = readBooleanAttribute(splittingElement,
	// TRACKER_SETTINGS_ALLOW_EVENT_ATTNAME, Logger.VOID_LOGGER);
	...
	// // Merging
	// Element mergingElement =
	// element.getChild(TRACKER_SETTINGS_MERGING_ELEMENT);
	// allowMerging = readBooleanAttribute(mergingElement,
	// TRACKER_SETTINGS_ALLOW_EVENT_ATTNAME, Logger.VOID_LOGGER);
	...
	// */
	//
	// public static String echoFeatureCuttofs(final Map<String, Double>
	// featurePenalties) {
	// String str = "";
	...
	// public static final Map<String, Double> readTrackerFeatureMap(final
	// Element element) {
	// Map<String, Double> map = new HashMap<String, Double>();
	// List<Element> featurelinkingElements =
	// element.getChildren(TRACKER_SETTINGS_FEATURE_ELEMENT);
